...
public class SimulationAssuranceEmpruntController {
	...
	public Text[] doAssuranceEmprunt(double capitalEmp, double tauxEmp, int dureeEmp, double tauxAss) {
		...
		for (int mois=0; mois<dureeEmp; mois++) {
