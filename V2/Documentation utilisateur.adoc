...
Le guichetier a la possibilité de gérer les prélèvements automatiques d'un compte bancaire, ce qui signifie qu'il peut en créée en choisissant le montant prélevé chaque mois, savooir quel jour du mois il s'effectue, ainsi à qui cet argent est prélevé, en l'occurence ici c'est la banque.

Dans la gestion des comptes d'un client, nous pouvons voir un nouveau bouton nommé "Voir Prélèvements", c'est à partir d'ici que nous pourrons gérer tous les prélèvements du compte bancaire du client choisis.
...
En cliquant sur le bouton modifier "Modifier pél.auto", la même fenêtre que pour en créer un s'affiche, il est possible de modifier les mêmes informations, c'est-à-dire le montant, le jour et le bénéficiaire, une fois les modifications effectuer, il ne manque plus qu'à les confirmer en cliquant sur "Modifier", les changements sont visibles immédiatement dans la gestion des prélèvements.
...
En cliquant sur le bouton "Supprimer prél.auto" après avoir sélectionner un prélèvement, il sera effacer de la base de donnée immédiatement.
