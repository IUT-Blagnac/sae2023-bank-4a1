...
>|Titre 4+|CREATE un employé - Julien
...
>|Titre 4+|READ un employé - Julien
...
>|Titre 4+|UPDATE un employé - Julien
>|Objectif 4+| Vérifier qu'il est possible modifier les informations d'un employé
...
>|Titre 4+|Simuler un emprunt - Prescilla
...
>|Titre 4+|Simuler une assurance d'emprunt - Prescilla
