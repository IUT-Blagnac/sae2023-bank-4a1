...
|2    |Guichetier     | CRUD Prélèvement automatiques| C| D | | 
|2    |Guichetier     | CRUD Prélèvement automatiques| R| D | | 
|2    |Guichetier     | CRUD Prélèvement automatiques| U| D | | 
|2    |Guichetier     | CRUD Prélèvement automatiques| D| D | | 
